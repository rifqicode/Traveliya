...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<body>
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class="active"><a href="{{ url('/kereta') }}">Kereta</a></li>
									...
									<div class="tab-content">
									 <div role="tabpanel" class="tab-pane active" id="singletrip">
                                        ...
                                        <div class="input-field">
                                            ...
                                            <input type="text" class="form-control" id="from-place" placeholder="Kota/Stasiun"/>
                                        </div>
                                    </div>
                                    <div class="col-xxs-12 col-xs-6 mt">
                                        <div class="input-field">
                                            <label for="from">Tujuan    :</label>
                                            <input type="text" class="form-control" id="to-place" placeholder="Kota/Stasiun"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 mt">
                                        <section>
                                            ...
                                            <select class="cs-select cs-skin-border">
                                                ...
                                                <option value="firstclass">Eksekutif</option>
                                            </select>
                                        </section>
                                    </div>
                                    <div class="col-xxs-12 col-xs-6 mt">
		...
		<div id="fh5co-testimonial" style="background-image:url(images/train.jpg);">
		<div class="container">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<p>Copyright 2016   <a href="#">Module</a>. All Rights Reserved. <br>Made with <i class="icon-heart3"></i> by <a href="http://freehtml5.co/" target="_blank">Freehtml5.co</a> / Demo Images: <a href="https://unsplash.com/" target="_blank">Unsplash</a></p>
						</div>
					</div>
				</div>
			</div>
