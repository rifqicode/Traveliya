				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class="active"><a href="{{ url('/pesawat') }}">Pesawat</a></li>
										...
										<div class="row">
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													...
													<input type="text" class="form-control" id="from-place" placeholder="Kota/Bandara"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">Tujuan    :</label>
													<input type="text" class="form-control" id="to-place" placeholder="Kota/Bandara"/>
												</div>
											</div>
