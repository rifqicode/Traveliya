...
@section('content')
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0" style="background-image: url(images/candi.jpg);">
				<div class="desc">
					<div class="container">
						<div class="row">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Kenapa harus pesan di Traveliya ?</h3>
					</div>
				</div>
			</div>
			<div class="container">
				<div class="row row-bottom-padded-md">
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="fh5co-blog animate-box">
							<a href="#"><img class="img-responsive" src="images/travel.jpg" alt=""></a>
							<div class="blog-text">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<p>Copyright 2016  <a href="#">Module</a>. All Rights Reserved. <br>Made with <i class="icon-airplane"></i> by <a  target="_blank">Traveliya</a> </p>
						</div>
					</div>
				</div>
			</div>
